...
#define __GMP_CFLAGS " -Wall -g -O2 -arch x86_64 -m64 -Wno-error=format-nonliteral   -I/Library/Frameworks/GStreamer.framework/Versions/1.0/include  -mmacosx-version-min=10.10 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.sdk "
